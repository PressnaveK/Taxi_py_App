...
################################################################################
## Form generated from reading UI file 'BookingDriver.ui'
##
...
class Ui_BookingDriver(object):
    def setupUi(self, BookingDriver):
        if not BookingDriver.objectName():
            BookingDriver.setObjectName(u"BookingDriver")
        BookingDriver.resize(1054, 699)
        BookingDriver.setStyleSheet(u"background-color: rgb(0, 0, 0);")
        self.vb_widget = QTableWidget(BookingDriver)
...
"background-color: rgb(144, 144, 144);")
        self.label = QLabel(BookingDriver)
        ...
        self.btn_back = QPushButton(BookingDriver)
...
"color: rgb(0, 0, 0);")
        ...
        self.retranslateUi(BookingDriver)

        QMetaObject.connectSlotsByName(BookingDriver)
    # setupUi

    def retranslateUi(self, BookingDriver):
        BookingDriver.setWindowTitle(QCoreApplication.translate("BookingDriver", u"Frame", None))
        ___qtablewidgetitem = self.vb_widget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("BookingDriver", u"Booking_ID", None));
        ___qtablewidgetitem1 = self.vb_widget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("BookingDriver", u"Booking_Status", None));
        ___qtablewidgetitem2 = self.vb_widget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("BookingDriver", u"Customer_Name", None));
        ___qtablewidgetitem3 = self.vb_widget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("BookingDriver", u"Price", None));
        ___qtablewidgetitem4 = self.vb_widget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("BookingDriver", u"Payment Status", None));
        ___qtablewidgetitem5 = self.vb_widget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("BookingDriver", u"Pickup Address", None));
        ___qtablewidgetitem6 = self.vb_widget.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("BookingDriver", u"Destination Address", None));
        ___qtablewidgetitem7 = self.vb_widget.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("BookingDriver", u"Pickup Date", None));
        ___qtablewidgetitem8 = self.vb_widget.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("BookingDriver", u"Pickup Time", None));
        ___qtablewidgetitem9 = self.vb_widget.horizontalHeaderItem(9)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("BookingDriver", u"No. of Passengers", None));
        ___qtablewidgetitem10 = self.vb_widget.horizontalHeaderItem(10)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("BookingDriver", u"Booking Date", None));
        ___qtablewidgetitem11 = self.vb_widget.horizontalHeaderItem(11)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("BookingDriver", u"FeedBack", None));
        ___qtablewidgetitem12 = self.vb_widget.horizontalHeaderItem(12)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("BookingDriver", u"Driver name", None));
        self.label.setText(QCoreApplication.translate("BookingDriver", u"Booking Info", None))
        self.btn_back.setText(QCoreApplication.translate("BookingDriver", u"Back", None))
    # retranslateUi
